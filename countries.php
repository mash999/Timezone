...
<optgroup label="Africa">
    <option value="0">Abidjan</option>
    <option value="0">Accra</option>
    <option value="3">Addis Ababa</option>
    <option value="1">Algiers</option>
    <option value="3">Asmara</option>
    <option value="0">Bamako</option>
    <option value="0">Bangui</option>
    <option value="0">Banjul</option>
    <option value="0">Bissau</option>
    ...
    <option value="0">Conakry</option>
    <option value="0">Dakar</option>
    <option value="3">Dar es Salaam</option>
    <option value="3">Djibouti</option>
    <option value="1">Douala</option>
    <option value="0">El Aaiun</option>
    <option value="0">Freetown</option>
    <option value="2">Gaborone</option>
    <option value="2">Harare</option>
    <option value="2">Johannesburg</option>
    <option value="3">Juba</option>
    ...
    <option value="0">Lome</option>
    <option value="1">Luanda</option>
    <option value="2">Lubumbashi</option>
    <option value="2">Lusaka</option>
    <option value="1">Malabo</option>
    <option value="2">Maputo</option>
    <option value="2">Maseru</option>
    <option value="2">Mbabane</option>
    <option value="3">Mogadishu</option>
    <option value="0">Monrovia</option>
    <option value="3">Nairobi</option>
    <option value="1">Ndjamena</option>
    <option value="1">Niamey</option>
    <option value="0">Nouakchott</option>
    <option value="0">Ouagadougou</option>
    <option value="1">Porto-Novo</option>
    <option value="0">Sao Tome</option>
    <option value="2">Tripoli</option>
    <option value="1">Tunis</option>
    <option value="2">Windhoek</option>
</optgroup>
